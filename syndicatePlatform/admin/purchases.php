    ...
    <div class="dashboard-container">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="active"><a href="purchases.php"><i class="fas fa-shopping-cart"></i> Purchases</a></li>
        ...
        <main class="main-content">
            <div class="content-header">
                <h1><i class="fas fa-shopping-cart"></i> Purchases</h1>
                <p>View and manage subscription purchases</p>
            </div>

            <div class="content-section">
                <h2>Coming Soon</h2>
                <p>This page will show all subscription purchases and allow you to process them.</p>
            </div>
        </main>
    </div>

    <script src="<?php echo BASE_URL; ?>public/public/assets/js/dashboard.js"></script>
</body>
</html>